// @SOURCE:/home/wouter/opt/play-2.1.0/samples/java/zentasks/conf/routes
// @HASH:c61c0852d82d76145d08afc6bd58ae8a432a7253
// @DATE:Sun Apr 28 00:32:07 CEST 2013
...
// @LINE:20
private[this] lazy val controllers_Projects_delete8 = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("projects/"),DynamicPart("project", """[^/]+"""))))
        

// @LINE:21
private[this] lazy val controllers_Projects_rename9 = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("projects/"),DynamicPart("project", """[^/]+"""))))
        

// @LINE:23
private[this] lazy val controllers_Projects_addUser10 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("projects/"),DynamicPart("project", """[^/]+"""),StaticPart("/team"))))
        

// @LINE:24
private[this] lazy val controllers_Projects_removeUser11 = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("projects/"),DynamicPart("project", """[^/]+"""),StaticPart("/team"))))
        

// @LINE:27
private[this] lazy val controllers_Tasks_index12 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("projects/"),DynamicPart("project", """[^/]+"""),StaticPart("/tasks"))))
        

// @LINE:28
private[this] lazy val controllers_Tasks_add13 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("projects/"),DynamicPart("project", """[^/]+"""),StaticPart("/tasks"))))
        

// @LINE:29
private[this] lazy val controllers_Tasks_update14 = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tasks/"),DynamicPart("task", """[^/]+"""))))
        

// @LINE:30
private[this] lazy val controllers_Tasks_delete15 = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tasks/"),DynamicPart("task", """[^/]+"""))))
...
// @LINE:33
private[this] lazy val controllers_Tasks_deleteFolder17 = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("projects/"),DynamicPart("project", """[^/]+"""),StaticPart("/tasks/folder"))))
        

// @LINE:34
private[this] lazy val controllers_Tasks_renameFolder18 = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("project/"),DynamicPart("project", """[^/]+"""),StaticPart("/tasks/folder"))))
